					...
					<td bgcolor="#F0F0F5" id="outLookBarShow" style="height: 100%"
						valign="bottom" align="center"><script type="text/javascript">
							models = "SPLITTiTlE=学生信息管理"
									+ "SPLITItEm=添加学生信息"
									+ "SPLITUrL=./web/studentManage/addStudent.action"
									+ "SPLITItEm=管理学生信息"
									+ "SPLITUrL=./web/studentManage/getStudentInforList.action"
									+ "SPLITItEm=学生信息查询"
									+ "SPLITUrL=./web/dep/stuSearch.jsp"
									+ "SPLITItEm=学期开学注册"
									+ "SPLITUrL=./web/studentManage/studentRegister.jsp"
									+ "SPLITItEm=学生休学管理"
									+ "SPLITUrL=./web/studentManage/studentDrop.jsp"
									+ "SPLITItEm=退课申请处理" 
									+ "SPLITUrL=./web/crManage/getCancelApplyList.action"

									+ "SPLITTiTlE=课程信息管理" 
									+ "SPLITItEm=添加课程信息"
									+ "SPLITUrL=./web/courseManage/courseAdd.jsp" 
									+ "SPLITItEm=课程信息管理"
									+ "SPLITUrL=./web/courseManage/getCourseList.action"
									+ "SPLITItEm=课程信息查询"
