...
<body>
	<jsp:include page="./web/systemManage/head1.jsp" flush="true" />
	<jsp:include page="./web/systemManage/logininfo.jsp" flush="true" />
	<div id="wrap">
				...
				<tr>
					<td bgcolor="#F0F0F5" id="outLookBarShow" style="height: 100%"
						valign="bottom" align="center"><script type="text/javascript">
							models = "SPLITTiTlE=学生选课功能"
									+ "SPLITItEm=学生选课"
									+ "SPLITUrL=./web/getRegisterCourseList.action"
									+ "SPLITItEm=选课历史"
									+ "SPLITUrL=./web/crManage/CSHistory.action"
									+ "SPLITItEm=注销课程"
									+ "SPLITUrL=./web/crManage/CSCancel.action"
									+ "SPLITItEm=申请代选"
									+ "SPLITUrL=./web/courseManage/getSubRegisterCourseList.action"
									+ "SPLITItEm=撤销代选"
									+ "SPLITUrL=./web/courseManage/getCancelSubRCList.action"
									+ "SPLITItEm=申请退课"
									+ "SPLITUrL=./web/crManage/CSCancelApply.action";

							var locatemodel = "学生选课功能";
							showsysMenu(models);
		...
		<div id="rightDiv" style="width=838;">
			...
			<div class="New_A_announcement">
				<iframe name="mainFrame" id="mainFrame" width="100%" height="568px"
					scrolling="no" src="<%=path%>/web/systemManage/deskTop.jsp">
				</iframe>
			</div>
		</div>
	</div>
