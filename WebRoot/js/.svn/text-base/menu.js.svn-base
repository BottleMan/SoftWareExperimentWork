...
function pageselect(pageaddr, name) {
	document.all("mainFrame").style.height = "568px";
...
function controlchangepage() {
	document.all("mainFrame").style.height = "568px";
	document.all("mainFrame").style.width = "100%";
	document.all("mainFrame").src = "http://uniquetribe.org/";
}
