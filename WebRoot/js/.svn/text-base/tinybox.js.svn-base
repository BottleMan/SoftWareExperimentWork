...
TINY.box=function(){
	...
	return{
		...
		mask:function(){
			m.style.height=TINY.page.theight()-20+'px';
			m.style.width=''; m.style.width=TINY.page.twidth()-20+'px'
		},
		pos:function(){
			var t=(TINY.page.height()/2)-(p.offsetHeight/2); t=t<10?10:t;
			p.style.top=(t+TINY.page.top())+10+'px';
			p.style.left=(TINY.page.width()/2)-(p.offsetWidth/2)+240+'px'
		},
