...
<body>
	<s:form theme="simple" name="thisForm" namespace="/web" action="studentDrop">
		<table style="BORDER-COLLAPSE: collapse; margin-top: 20px"
			borderColor=#cccccc cellSpacing=0 cellPadding=0 width="100%"
			align=center border=0>
			<tbody>
				<tr>
					<td style="FONT-SIZE: 14px" align=center><B>学生休学管理</B>
					</td>
				</tr>
			</tbody>
		</table>
		...
		<table id="table_1" class="table_border" cellSpacing=0 cellPadding=0;
			...
			<tr>
				...
				<td class="table_td"><s:select id="DropOut" name="DropOut"
						list="#{'2':'--请选择--','1':'学籍冻结','0':'学籍解冻'}"/>
				</td>
			</tr>
